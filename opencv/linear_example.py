...
# would be learned by our model, but for the sake of this example
...
# our image is now represented as (32, 32, 3) Numpy array
image = cv2.resize(orig, (32,32)).flatten()

# compute the output scores by taking the dot product between
# the weight matrix and image pixels, followed by adding in bias
