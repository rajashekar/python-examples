...
# Red, Blue & Green, with a black back ground
...
# lets draw one last rectable blue and filled in
blue = (255, 0 ,0)
...
# incresing radii - from 25 pixels to 150 pixels
canvas = np.zeros((300, 300, 3), dtype="uint8")
...
for i in range(0, 25):
    ...
    # generate a random color and then pick a random point on our canvas
